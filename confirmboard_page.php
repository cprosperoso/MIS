...
case "small":
$est_amount = strval($numroom*65 * $numOfDays);
//print "<p><b> Est. Amount:</b> ".$est_amount."\n</p";
break;
case "medium":
$est_amount = strval($numroom*75 * $numOfDays);
//print "<p><b> Est. Amount:</b> ".$est_amount."\n</p>";
break;
default:
$est_amount = strval($numroom*85 * $numOfDays);
//print "<p><b> Est. Amount:</b> ".$est_amount."\n</p>";
}

$est_amount = $est_amount." Baht";
$_SESSION["est_amount"] = $est_amount;
...
<?php endif;?>
        ...
        <div class="v18 ps162 s192 c152">
          <div class="v18 ps160 s193 c157">
            <p class="p9 f37">Check In Date &amp; Time:</p>
          </div>
          <div class="v18 ps161 s194 c158">
<p class="p9 f37"><?php echo $checkin;?></p>
          </div>
        </div>
        <div class="v18 ps163 s195 c152">
          <div class="v18 ps160 s196 c159">
            <p class="p9 f37">Check Out Date &amp; Time:</p>
          </div>
          <div class="v18 ps161 s197 c160">
<p class="p9 f37"><?php echo $checkout;?></p>
          </div>
        </div>
        <div class="v18 ps163 s198 c152">
          <div class="v18 ps160 s199 c161">
            <p class="p9 f37">Number of Rooms:</p>
          </div>
          <div class="v18 ps161 s200 c162">
<p class="p9 f37"><?php echo $numroom;?></p>
          </div>
        </div>
        <div class="v18 ps163 s195 c152">
          <div class="v18 ps160 s196 c163">
            <p class="p9 f37">Pet Size:</p>
          </div>
          <div class="v18 ps161 s197 c164">
<p class="p9 f37"><?php echo $petsize;?></p>
          </div>
        </div>
        <div class="v18 ps163 s192 c152">
          <div class="v18 ps160 s193 c165">
            <p class="p9 f37">Pet Type:</p>
          </div>
          <div class="v18 ps161 s194 c166">
<p class="p9 f37"><?php echo $p_type;?></p>
          </div>
        </div>
        <div class="v18 ps164 s201 c152">
          <div class="v18 ps160 s202 c167">
            <p class="p9 f38">Amount:</p>
          </div>
          <div class="v18 ps165 s197 c168">
<p class="p9 f37" align="left"><b><?php echo $est_amount;?></b></p>
          </div>
        </div>
        <div class="v18 ps166 s203 c152">
          <div class="v18 ps160 s204 c169">
            <a href="services.php" class="f40 btn20 v20 s205">&lt;&lt; Back</a>
          </div>
          <div class="v18 ps167 s204 c170">
            <a href="creditcard.php" class="f40 btn21 v20 s205">Confirm Booking &gt;&gt;</a>
	    <!--button onclick="myFunction()" id="myBtn" class="f40 btn21 v20 s205">Confirm Booking &gt;&gt;</button-->
          </div>
        </div>
      </div>
    </div>
...
<div id="myModal" class="modal">
  ...
  <script>
    dpth = "/";
    ! function() {
      var s = ["js/jquery.c71cd4.js", "js/confirmboard_page.6c8feb.js"],
        n = {},
        j = 0,
        e = function(e) {
