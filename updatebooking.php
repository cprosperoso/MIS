...
<body id="b">
    ...
    <div class="s249">
      <div class="v25 ps206 s250 c210">
        ...
        <div class="v25 ps207 s252 c212">
          <p class="p14 f53">Booking to Update</p>
        </div>
        <div class="v25 ps208 s253 c213">
          <div class="v25 ps209 s254 c214">
            <p class="p15 f54">Booking Reference :</p>
          </div>
          <div class="v25 ps210 s255 w5">
            <div class="v25 ps209 s256 c215">
              <!--p class="p15 f55">booking reference</p-->
              <input id="booking_ref" name="booking_ref" type="text" class="p15 f55"></input>
            </div>
            <div class="v25 ps211 s257 c216">
              <p class="p15 f56">&lt;Input booking number then Press ENTER&gt;</p>
            </div>
          </div>
        </div>
        <div class="v25 ps212 s258 c213">
          <div class="v25 ps209 s259 c217">
            <p class="p15 f54">Owner&rsquo;s Name:</p>
          </div>
          <div class="v25 ps209 s260 c218">
            <!--p class="p15 f57">owner name</p-->
            <div id="owner" class="p15 f57">name here</div>
          </div>
          <div class="v25 ps213 s261 c219">
            <p class="p15 f54">Email Address:</p>
          </div>
          <div class="v25 ps209 s262 c220">
            <!--p class="p15 f57">email address</p-->
            <div id="email" class="p15 f57">email here</div>
          </div>
        </div>
        <div class="v25 ps214 s263 c213">
          <div class="v25 ps209 s254 c221">
            <p class="p15 f54">Date In :</p>
          </div>
          <div class="v25 ps215 s264 c222">
            <!--p class="p15 f58">check in date and time</p-->
            <div id="datefield" class="p15 f58">check in date and time</div>
          </div>
        </div>
        <div class="v25 ps216 s265 c213">
          <div class="v25 ps209 s266 c223">
            <p class="p15 f54">Date Out :</p>
          </div>
          <div class="v25 ps215 s267 c224">
            <!--p class="p15 f58">check out date and time</p-->
            <div id="datefield1" class="p15 f58">N/A</div>
          </div>
        </div>
        <div class="v25 ps216 s268 c213">
          <div class="v25 ps209 s269 c225">
            <p class="p15 f54">Time In :</p>
          </div>
          <div class="v25 ps215 s270 c226">
            <!--p class="p15 f58">check out date and time</p-->
            <div id="timefield1" class="p15 f58">N/A</div>
          </div>
        </div>
        <div class="v25 ps216 s271 c213">
          <div class="v25 ps209 s266 c227">
            <p class="p15 f54">Number of Rooms :</p>
          </div>
          <div class="v25 ps215 s272 c228">
            <!--p class="p15 f58">check out date and time</p-->
            <div id="numRoom" class="p15 f58">N/A</div>
          </div>
        </div>
        <div class="v25 ps217 s268 c213">
          ...
          <div class="v25 ps215 s270 c230">
            ...
            <select class="p15 f54" name="status" id="status">
               <option class="p15 f54" value="Confirmed">Confirmed</option>
               <option class="p15 f54" value="Cancelled">Cancelled</option>
               <option class="p15 f54" value="Reserved">Reserved</option>
               <option class="p15 f54" value="Checked Out">Checked Out</option>
            </select>
            </div>
          </div>
        </div>
        <div class="v25 ps218 s273 c213">
          ...
          <div class="v25 ps219 s274 c232">
            ...
            <button onclick="myFunction()" id="myBtn" class="f60 btn26 v27 s275">Confirm Change &gt;&gt;</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>&nbsp;</p>
          <p>Booking was successfully updated!</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
        </div>
  ...
  function retrieveBooking(){
          ...
          var bookingNum = document.getElementById("booking_ref").value;
          $.ajax({
                  ...
                  success: function(data)
                  {
                    ...
                    var stat = data[7];
                    var name = data[8];
                    $('#booking_ref').html("<p><b>Booking Ref: "+booking_ref+"<b><p>");
                    $('#owner').html("<p>"+name+"</p>");
                    $('#email').html("<p>"+email+"</p>");
                    $('#datefield').html("<p>"+date_in+"</p>");
                    $('#datefield1').html("<p>"+date_out+"</p>");
                    $('#timefield1').html("<p>"+time_in+"</p>");
                    $('#status').val(stat);
  ...
  <script>
function updateBookingStat(){

	var jsvar = document.getElementById("booking_ref").value; 
